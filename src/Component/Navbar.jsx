...
import { Text, Avatar, AvatarBadge, Spinner, Menu, MenuButton, MenuList, MenuItem, MenuDivider, Badge, Button, ButtonGroup } from "@chakra-ui/react";
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item" onClick={() => navigate("/products")}>
              <span className="nav-link main-content-color" style={{ cursor: "pointer" }}>
                Products
              </span>
            </li>
