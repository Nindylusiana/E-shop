      ...
      <div className="container py-5">
        <div className="row bg-white my-5 shadow rounded">
          ...
          <div className="col-12 col-md-4 p-5 shadow">
            ...
            <Button type="button" width="full" colorScheme="teal" variant="solid" onClick={onRegis}>
              Create an account
            </Button>
            <div className="text-center text-muted">
              <span>or</span>
            </div>
            <button onClick={() => window.open(`https://google.com`, "_blank").focus()} className="btn btn-light py-2 text-muted mt-2 w-100 shadow">
