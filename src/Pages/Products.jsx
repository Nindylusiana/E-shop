...
import { Text, Button, Image, useToast } from "@chakra-ui/react";
...
const Products = (props) => {
  ...
  const printData = () => {
    ...
    return data.map((val, idx) => {
      return (
        <div className="col-12 col-sm-6 col-lg-4 " onClick={() => navigate(`/detail?id=${val.id}`)} key={val.id}>
            ...
            <div className="card-body">
              ...
              <div className="row">
                <div className="col-12  my-2 ">
                  <input className="form-control" value={filterName} onChange={(element) => setFilterName(element.target.value)} type="text" placeholder="Name" />
                </div>
                <div className="col-12 my-2">
